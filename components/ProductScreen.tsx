...
//   rending Products 
  const renderProduct = ({ item }) => (
    ...
    <View style={{width:"100%",paddingHorizontal:5,paddingVertical:5}}><Image source={{ uri: item.image }} style={styles.image} /></View>
  ...
  return (
    <View style={styles.container}>
      <FlatList
        ...
        ListFooterComponent={loading ? <ActivityIndicator size="large" color="#FF8C00" /> : null}
      />
